...
export default function ServiceSection() {
  return (
    <section className="w-full bg-white py-15 md:py-20">
      <div className="mx-auto flex w-full max-w-[324px] flex-col items-center gap-7.5 md:max-w-293 md:flex-row md:items-start md:gap-18.5">
        <div className="md:mt-7.5">
