...
const TERMS_SECTIONS: TermsSection[] = [
  {
    title: '제1조 (목적)',
    content:
      '본 약관은 모아쌤 운영팀이 제공하는 모아쌤 서비스의 이용과 관련하여 운영팀과 이용자 간의 본적인 사항을 정하는 것을 목적으로 합니다.',
  },
  {
    title: '제2조 (용어의 정의)',
    content: [
  ...
  },
  {
    title: '제8조 (AI 생성횟수)',
    content:
      '서비스는 AI 관찰일지 생성 등 일부 기능 이용을 위해 AI 생성횟수를 사용할 수 있습니다. AI 생성횟수는 서비스 운영 정책에 따라 지급, 차감, 또는 조정될 수 있습니다. 현재 AI 생성횟수가 무료로 제공되는 경우, 환한 환불이나 교환은 제공되지 않습니다.',
  },
  {
  ...
  {
    title: '제17조 (부칙)',
    content: '본 약관은 2026년 5월 30일 부터 적용됩니다.',
  },
];
